...
Summary: User - “Nivo edukacije” screen  | User cannot add a degree level from the “Nivo edukacije” screen
...
Precondition: The user has successfully fulfilled previous steps for registration and it is on “Edukacija” screen 
Steps to reproduce: 
...
Attachments: ![Attachment:](https://drive.google.com/drive/folders/1MAeEN1NqCo8exmpjoIZ1680h68aDA_yi/benefitiname.png)



ID: bug_2  

Summary: User - Benefiti | Some benefits full-name are not displayed.
...
Precondition: The user is on benefit screen.
Steps to reproduce: 
Pay attention to the screen

Expected result: The user can see the full name of benefits and select/change it.
...
Summary: Users’ profile | The “Veštine” and “Odjavi me” sections are overlapping.
...
Expected result: The “Odjavi me” and “Obriši profil” sections are separate from the top sections at least by the size of one section.
